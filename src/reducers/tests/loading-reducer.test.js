...
import { START_MOVIES_LIST, START_DETAILS_FETCHED, COMPLETED_MOVIES_LIST, COMPLETED_DETAILS_FETCHED, SET_ERROR } from "../../actions/types"
...
describe('loading-reducer', () => {
    ...
    test('that completedDetailsFetched is working correctly', ()=> {
        expect(loadingReducer(true, {type: COMPLETED_DETAILS_FETCHED})).toBe(false)
    })
